...
let Friends:string[] = ["Aftab","Abid", "Murad","Jawad","Shahzaib"] // Array Declaration
// For Loop
for(let i = 0; i<Friends.length; i++){
    console.log(`Hello ${Friends[i]}, Mistakes are opportunities to learn and grow. Don't fear them.`); // Print
}